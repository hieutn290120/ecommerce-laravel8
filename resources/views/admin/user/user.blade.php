...
<div class="container-fluid">
    ...
    <div class="row">
        ...
        <div class="col-lg-4 col-xlg-3 col-md-5">
            <div class="card">
                <div class="card-body">
                    <center class="m-t-30"> <img src="{{ asset('upload/image_user') }}/{{Auth::user()->avatar }}" class="rounded-circle" width="150" />
                ...
                <div class="card-body">
                    <form class="form-horizontal form-material" method="post" enctype='multipart/form-data'>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-12">
                                <input type="text" placeholder="Thua Thien Hue" name="address" value="{{Auth::user()->address }}" class="form-control form-control-line">
                            </div>
                        </div>
                        @error('address')
                        <span style="color:red;">{{$message}}</span></br>
